...
<script type="text/javascript">
	...
	{
		var form = document.id('classroom-form');
		if (task == 'classroom.cancel' || document.formvalidator.isValid(form)) {
...
<form action="<?php echo JRoute::_('index.php?option=com_eschool&layout=edit&id='.(int) $this->item->id); ?>"
	method="post" name="adminForm" id="classroom-form" class="form-validate">
	...
	<div class="width-40 fltrt">
		<?php echo JHtml::_('sliders.start','classroom-sliders-'.$this->item->id, array('useCookie' => 1)); ?>
