 ...
 * @since       1.0
 */
class EschoolViewStudent extends JViewLegacy
{
	/**
	...
	/**
	 * Prepare and display the Student view.
	 *
	 * @return  void
	 * @since   1.0
	 */
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(
			JText::_(
				...
				($checkedOut
					? 'VIEW_STUDENT'
					: ($isNew ? 'ADD_STUDENT' : 'EDIT_STUDENT')).'_TITLE'
			)
		);
		...
		if (!$checkedOut && $canDo->get('core.edit')) {
			...
			JToolBarHelper::custom('student.save2new', 'save-new.png', null, 'JTOOLBAR_SAVE_AND_NEW', false);
		}

		// If an existing item, can save to a copy.
		if (!$isNew && $canDo->get('core.create')) {
			JToolBarHelper::custom('student.save2copy', 'save-copy.png', null, 'JTOOLBAR_SAVE_AS_COPY', false);
		}
