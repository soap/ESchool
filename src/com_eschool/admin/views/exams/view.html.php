 ...
 * @since       1.0
 */
class EschoolViewExams extends JViewLegacy
{
	/**
	...
	/**
	 * Prepare and display the Exams view.
	 *
	 * @return  void
	 * @since   1.0
	 */
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_ESCHOOL_EXAMS_TITLE'));
		...
		if ($canDo->get('core.edit.state')) {
			JToolBarHelper::publishList('exams.publish', 'JTOOLBAR_PUBLISH');
			JToolBarHelper::unpublishList('exams.unpublish', 'JTOOLBAR_UNPUBLISH');
