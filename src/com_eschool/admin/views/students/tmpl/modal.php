...
$function  = JFactory::getApplication()->input->getCmd('func', 'esSelectSemester');
$user		= JFactory::getUser();
$listOrder	= $this->escape($this->state->get('list.ordering'));
$listDirn	= $this->escape($this->state->get('list.direction'));
?>
<form action="<?php echo JRoute::_('index.php?option=com_eschool&tmpl=component&layout=modal&view=semesters');?>" method="post" name="adminForm">
	...
	<table class="adminlist">
		...
		<?php foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
                <td>
                	<?php $title = $item->first_name.' '.$item->last_name.' ('.$item->student_code.')';?>
