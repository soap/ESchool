 ...
 * @since       1.0
 */
class EschoolViewExam extends JViewLegacy
{
	/**
	...
	/**
	 * Prepare and display the Exam view.
	 *
	 * @return  void
	 * @since   1.0
	 */
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(
			JText::_(
				...
				($checkedOut
					? 'VIEW_EXAM'
					: ($isNew ? 'ADD_EXAM' : 'EDIT_EXAM')).'_TITLE'
			)
		);
		...
		if (!$checkedOut && $canDo->get('core.edit')) {
			...
			JToolBarHelper::custom('exam.save2new', 'save-new.png', null, 'JTOOLBAR_SAVE_AND_NEW', false);
		}

		// If an existing item, can save to a copy.
		if (!$isNew && $canDo->get('core.create')) {
			JToolBarHelper::custom('exam.save2copy', 'save-copy.png', null, 'JTOOLBAR_SAVE_AS_COPY', false);
		}
