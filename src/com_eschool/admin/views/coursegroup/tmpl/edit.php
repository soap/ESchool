...
<script type="text/javascript">
	...
	{
		var form = document.id('coursegroup-form');
		if (task == 'coursegroup.cancel' || document.formvalidator.isValid(form)) {
...
<form action="<?php echo JRoute::_('index.php?option=com_eschool&layout=edit&id='.(int) $this->item->id); ?>"
	method="post" name="adminForm" id="coursegroup-form" class="form-validate">
	...
	<div class="width-40 fltrt">
		<?php echo JHtml::_('sliders.start','coursegroup-sliders-'.$this->item->id, array('useCookie' => 1)); ?>
