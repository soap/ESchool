...
<script type="text/javascript">
	...
	{
		var form = document.id('rawscore-form');
		if (task == 'rawscore.cancel' || document.formvalidator.isValid(form)) {
...
<form action="<?php echo JRoute::_('index.php?option=com_eschool&layout=edit&id='.(int) $this->item->id); ?>"
	method="post" name="adminForm" id="rawscore-form" class="form-validate">
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			<ul class="adminformlist">
				...
				<li>
					<?php echo $this->form->getLabel('score')?>
					<?php echo $this->form->getInput('score')?>
				</li>
				<li>
	...
	<div class="width-40 fltrt">
		<?php echo JHtml::_('sliders.start','rawscore-sliders-'.$this->item->id, array('useCookie' => 1)); ?>
