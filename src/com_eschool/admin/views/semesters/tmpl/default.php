...
?>
<form action="<?php echo JRoute::_('index.php?option=com_eschool&view=semesters');?>" method="post" name="adminForm">
	<fieldset id="filter-bar">
		<div class="filter-search fltlft">
			...
			<input type="text" name="filter_search" id="filter_search"
				...
				title="<?php echo JText::_('COM_ESCHOOL_SEMESTERS_FILTER_SEARCH_DESC'); ?>" />
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<?php if ($item->checked_out) : ?>
						<?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'semesters.', $canCheckin); ?>
					<?php endif; ?>
					<?php if ($canCreate || $canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_eschool&task=semester.edit&id='.$item->id);?>">
