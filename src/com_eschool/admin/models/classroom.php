 ...
 * @since       1.0
 */
class EschoolModelclassroom extends JModelAdmin
{
	/**
	 * Method to get the classroom form.
	 *
	 ...
	 * @since   1.0
	 */
	public function getTable($type = 'classroom', $prefix = 'EschoolTable', $config = array())
	{
	...
	protected function prepareTable(&$table)
	{
		...
		if (empty($table->id)) {
			...
			if (empty($table->ordering)) {
				...
				$query->from('#__eschool_classrooms');
				$query->where('classlevel_id = '.(int) $table->classlevel_id);
