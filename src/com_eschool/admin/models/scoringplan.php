 ...
 * @since       1.0
 */
class EschoolModelScoringplan extends JModelAdmin
{
	/**
	 * Method to get the Scoringplan form.
	 *
	...
	{
		$condition = array(
			'semester_id = '.(int) $table->semester,
			'syllabus_course_id = '.(int) $table->syllabus_course_id,
		);
	 ...
	 * @since   1.0
	 */
	public function getTable($type = 'Scoringplan', $prefix = 'EschoolTable', $config = array())
	{
