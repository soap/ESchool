 ...
 * @since       1.0
 */
class EschoolModelSemester extends JModelAdmin
{
	/**
	 * Method to get the Semester form.
	 *
	 ...
	 * @since   1.0
	 */
	public function getTable($type = 'Semester', $prefix = 'EschoolTable', $config = array())
	{
