 ...
 * @since       1.0
 */
class EschoolModelClasslevel extends JModelAdmin
{
	/**
	 * Method to get the Classlevel form.
	 *
	 ...
	 * @since   1.0
	 */
	public function getTable($type = 'Classlevel', $prefix = 'EschoolTable', $config = array())
	{
