 ...
 * @since       1.0
 */
class EschoolModelCoursegroup extends JModelAdmin
{
	/**
	 * Method to get the Coursegroup form.
	 *
	 ...
	 * @since   1.0
	 */
	public function getTable($type = 'Coursegroup', $prefix = 'EschoolTable', $config = array())
	{
	...
	protected function prepareTable(&$table)
	{
		...
		if (empty($table->id)) {
			...
			if (empty($table->ordering)) {
				...
				$query->from('#__eschool_coursegroups');
