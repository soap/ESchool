 ...
 * @since       1.0
 */
class EschoolModelRawscore extends JModelAdmin
{
	/**
	 * Method to get the Rawscore form.
	 *
	 ...
	 * @since   1.0
	 */
	public function getTable($type = 'Rawscore', $prefix = 'EschoolTable', $config = array())
	{
	...
	protected function prepareTable(&$table)
	{
		...
		if (empty($table->id)) {
			...
			if (empty($table->ordering)) {
				...
				$query->from('#__eschool_rawscores');
				$query->where('exam_id = '.(int) $table->exam_id);
